...
class Net(nn.Module):
    ...
    def forward(self, inputs, i, j):
        move_set_idx = inputs["move_set_idx"][i:j]
        move_set_x = inputs["move_set_x"][i:j]
        move_pool_idx = inputs["move_pool_idx"][i:j]
        move_pool_x = inputs["move_pool_x"][i:j]
        move_lookup_idx = inputs["move_lookup_idx"][i:j]
        move_lookup_x = inputs["move_lookup_x"][i:j]
        ability_idx = inputs["ability_idx"][i:j]
        item_idx = inputs["item_idx"][i:j]
        item_lookup_idx = inputs["item_lookup_idx"][i:j]
        user_x = inputs["user_x"][i:j]
        user_mask = inputs["user_mask"][i:j]
        side_x = inputs["side_x"][i:j]
        active_idx = inputs["active_idx"][i:j]
        battle_x = inputs["battle_x"][i:j]
        move_option_idx = inputs["move_option_idx"][i:j]
        move_option_x = inputs["move_option_x"][i:j]
        move_option_mask = inputs["move_option_mask"][i:j]
        switch_option_mask = inputs["switch_option_mask"][i:j]
